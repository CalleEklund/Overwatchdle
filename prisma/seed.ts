...
async function main() {
    ...
    /*const test = await prisma.heroes.create({
        data: {
            name: 'McCree',
    ...
    const t2 = await prisma.$executeRaw`INSERT INTO HEROES VALUES (1,'Genji',
